      ...
      const data = [
        {
          ...
          descripcion: "Nuestra sede principal ubicada en el corazón de Pisco, a pocos minutos del muelle de embarque para las Islas Ballestas. Cuenta con amplio estacionamiento, cafetería y todas las comodidades para iniciar tu aventura marina."
        },
        {
          id: 2,
          nombre: "Sede Paracas",
          ...
          descripcion: "Ubicada frente a la hermosa bahía de Paracas, nuestra sede ofrece tours directos a la Reserva Nacional de Paracas y experiencias de avistamiento de fauna marina. Disfruta de nuestro lounge con vista al mar mientras esperas tu aventura."
        },
        {
          id: 3,
    ...
    <div>
      ...
      <div className="relative h-64 md:h-80 bg-gray-900 overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">{t('sedes.titulo')}</h1>
                  ...
                  >
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-500 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <span className="text-gray-700 dark:text-gray-300">{sede.direccion}</span>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">{sede.telefono}</span>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">{sede.correo}</span>
                      </div>
                    </div>
      ...
      <Seccion className="py-16 bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex justify-center">
          <Link
            to="/contacto"
            className="px-6 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-full text-lg font-semibold transition-colors duration-300 shadow-md hover:shadow-lg"
          >
