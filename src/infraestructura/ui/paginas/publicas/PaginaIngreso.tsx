      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          <Link to="/" className="inline-block">
            <h2 className="text-3xl font-bold text-primary-600 dark:text-primary-400">
              Ocean<span className="text-gray-800 dark:text-white">Tours</span>
            </h2>
          </Link>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            {t('ingreso.subtitulo')}{' '}
            <Link to="/registrarse" className="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
        ...
        >
          ...
          <div className="mt-6 text-center">
            <Link to="/recuperar-contrasena" className="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
